...
dictionary = p1.bag_of_words(test_texts)
...
# -------------------------------------------------------------------------------
# Problem 7: Accuracy of classifiers
# -------------------------------------------------------------------------------
...
print("{:45} {:.4f}".format("Training accuracy for Pegasos:", avg_peg_train_accuracy))
print("{:45} {:.4f}".format("Validation accuracy for Pegasos:", avg_peg_val_accuracy))
